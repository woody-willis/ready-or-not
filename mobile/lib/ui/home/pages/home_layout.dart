      ...
      await showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text('This app requires location permission to function properly.'),
            actions: [
              TextButton(
                onPressed: () {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: TextFormField(
            initialValue: Constants.prefs!.getString('displayName') ?? loginBloc.state.user.name,
            onChanged: (value) {
